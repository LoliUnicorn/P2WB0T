...
public class StatsModule implements Modul {
    ...
    private void test() {
        ...
        getStatsCache().addZmutowanych("343467373417857025", 1);
        getStatsCache().addZbanowanych("343467373417857025", 1);
        getStatsCache().addUsunietychWiadomosci("343467373417857025", 1);
